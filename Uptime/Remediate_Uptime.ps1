...
$LogoImageUri = "https://azrintunestoragefiles.blob.core.windows.net/uptimefiles/symbol.png"
$HeroImageUri = "https://azrintunestoragefiles.blob.core.windows.net/uptimefiles/Logo_Post_White_1.png"
